 ...
 private String path;
  ...
  private void copy(InputStream is,OutputStream os) throws Exception{
     // encryption time varies with different size of buffer
      byte buf[] = new byte[4096000];  //4K buffer set
     int read = 0;
     ...
     public static void main (String[] args)throws Exception {
      //new FileEncryptor("DES/ECB/PKCS5Padding","D://Dil Hai Ke Manta Nahin.avi").encrypt();
      new FileEncryptor("DES/ECB/PKCS5Padding","D://Dil Hai Ke Manta Nahin.avi.enc").decrypt();
  }
}